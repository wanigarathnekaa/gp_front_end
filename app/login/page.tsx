  ...
  return (
    ...
    <div className="flex min-h-full flex-col lg:px-8l bg-[#D6D6FF]">
      ...
      <header className="flex justify-center items-center h-16 bg-[#ffffff] shadow-lg">
        ...
        <div className="my-52 sm:mx-auto sm:w-full sm:max-w-sm p-10 bg-[#ffffff] rounded-xl shadow-xl">
          <h2 className="mb-3 text-center text-3xl font-bold leading-9 tracking-tight text-gray-800">
            Login
          </h2>
